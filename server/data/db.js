...
const azure = require("azure-storage"),
  ...
  maybeReadFile = require("marigold-build/src/maybeReadFile"),
  secretsFile = maybeReadFile("server/data/secrets.json"),
  secrets = secretsFile && JSON.parse(secretsFile.toString("utf8")),
  connectionString = secrets && secrets.connectionString || null,
